...
class GameMap:
    ...
    def new_num(self):
        empty_slots = []
        for row in range(len(self.game_map[0].values())):
    ...
    def print_current(self):
        ...
        print("     ", end="")
        for x in range(len(self.game_map[0].keys())):
            spaces = " " * (biggest - len(str(x)) + 1)
            print(x, spaces, end="")
        print()

    def movement_check(self):
        for row in self.game_map[0].values():  # quick blank slot check
            for item in row:
                if item == 0:
                    return True
                    ...
                    if self.game_map[0][row][item] != 0:
                        ...
                        while not end:
                            if row == 3:
                                ...
                                break
                            elif self.game_map[0][row + 1][item] == 0:  # Moved to new spot if the spot contains no numbers
                            ...
                            elif self.game_map[0][row + 1][item] == self.game_map[0][row][item]:  # Adds two numbers and merges
